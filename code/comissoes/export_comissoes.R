...
source(here::here("code/comissoes/process_comissoes.R"))
...
option_list = list(
  ...
  make_option(c("-o", "--outComposicoes"), type="character", default=here::here("data/ready/comissoes/composicao_comissoes.csv"),
              help="nome do arquivo de saída para as informações de composição de comissões [default= %default]", metavar="character"),
  
  make_option(c("-c", "--outComissoes"), type="character", default=here::here("data/ready/comissoes/comissoes.csv"),
