...
.HELP <- "
Usage:
Rscript export_pressao -u <url_api_painel> -p <painel> -i <data_inicial> -f <data_final> -e <export_filepath>
...
export_filepath: Caminho para exportação dos dados de pressão
"
...
pressao <-
  fetch_pressao_by_painel(url, painel, data_inicial, data_final, proposicoes)

write_csv(pressao, here::here(saida))
